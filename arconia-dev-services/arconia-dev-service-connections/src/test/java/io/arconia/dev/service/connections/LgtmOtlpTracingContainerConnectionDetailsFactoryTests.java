...
import io.arconia.opentelemetry.autoconfigure.tracing.exporter.otlp.OtlpTracingConnectionDetails;
import io.arconia.opentelemetry.autoconfigure.tracing.exporter.otlp.OtlpTracingExporterAutoConfiguration;
 ...
 */
@SpringJUnitConfig
@TestPropertySource(properties = "arconia.opentelemetry.traces.enabled=false")
class LgtmOtlpTracingContainerConnectionDetailsFactoryTests extends LgtmTestcontainers {
    ...
    @ImportAutoConfiguration(OtlpTracingExporterAutoConfiguration.class)
