 ...
 */
class OnEnabledOpenTelemetryMetricsCondition extends SpringBootCondition {
    ...
    public ConditionOutcome getMatchOutcome(ConditionContext context, AnnotatedTypeMetadata metadata) {
        ...
        if (openTelemetryMetricsEnabled != null) {
            return new ConditionOutcome(openTelemetryMetricsEnabled,
                    ConditionMessage.forCondition(ConditionalOnEnabledOpenTelemetryMetrics.class)
                            .because(OpenTelemetryMetricsProperties.CONFIG_PREFIX + ".enabled is " + openTelemetryMetricsEnabled));
        }

        return ConditionOutcome.match(ConditionMessage.forCondition(ConditionalOnEnabledOpenTelemetryMetrics.class)
