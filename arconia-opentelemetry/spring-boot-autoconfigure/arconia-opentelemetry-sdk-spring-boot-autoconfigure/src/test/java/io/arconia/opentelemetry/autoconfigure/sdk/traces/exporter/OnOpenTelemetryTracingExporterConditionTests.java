...
class OnOpenTelemetryTracingExporterConditionTests {
    ...
    void shouldMatchWhenTracesExporterTypeMatches() {
        environment.setProperty("arconia.otel.traces.exporter.type", "console");
        ...
        assertThat(outcome.getMessage())
                .contains("arconia.otel.traces.exporter.type is set to CONSOLE");
    }
    ...
    void shouldNotMatchWhenExporterTypeDoesNotMatch() {
        ...
        assertThat(outcome.getMessage())
                .contains("arconia.otel.traces.exporter.type is set to CONSOLE, but requested none");
    }
    ...
    void shouldPrioritizeTracesExporterTypeOverGeneralExporterType() {
        ...
        environment.setProperty("arconia.otel.traces.exporter.type", "otlp");
        when(context.getEnvironment()).thenReturn(environment);
        ...
        assertThat(outcome.isMatch()).isTrue();
        assertThat(outcome.getMessage())
                .contains("arconia.otel.traces.exporter.type is set to OTLP");
    }
