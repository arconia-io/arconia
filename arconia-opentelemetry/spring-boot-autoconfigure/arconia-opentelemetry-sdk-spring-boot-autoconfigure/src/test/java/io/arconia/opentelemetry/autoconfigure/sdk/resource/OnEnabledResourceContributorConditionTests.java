...
/**
 * Unit tests for {@link OnEnabledResourceContributorCondition}.
 */
class OnEnabledResourceContributorConditionTests {

    private final OnEnabledResourceContributorCondition condition = new OnEnabledResourceContributorCondition();
    ...
    void shouldMatchWhenContributorIsEnabled() {
        environment.setProperty("arconia.opentelemetry.resource.test-contributor.enabled", "true");
        ...
        when(metadata.getAnnotationAttributes(ConditionalOnEnabledResourceContributor.class.getName()))
        ...
        assertThat(outcome.getMessage())
                .contains("arconia.opentelemetry.resource.test-contributor.enabled is true");
    }

    @Test
    void shouldNotMatchWhenContributorIsDisabled() {
        environment.setProperty("arconia.opentelemetry.resource.test-contributor.enabled", "false");
        when(context.getEnvironment()).thenReturn(environment);
        ...
        assertThat(outcome.getMessage())
                .contains("arconia.opentelemetry.resource.test-contributor.enabled is false");
    }
