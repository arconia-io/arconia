...
class OnOpenTelemetryLoggingExporterConditionTests {
    ...
    void shouldMatchWhenLogsExporterTypeMatches() {
        environment.setProperty("arconia.otel.logs.exporter.type", "console");
        ...
        assertThat(outcome.getMessage())
                .contains("arconia.otel.logs.exporter.type is set to CONSOLE");
    }
    ...
    void shouldNotMatchWhenExporterTypeDoesNotMatch() {
        ...
        assertThat(outcome.getMessage())
                .contains("arconia.otel.logs.exporter.type is set to CONSOLE, but requested none");
    }
    ...
    void shouldPrioritizeLogsExporterTypeOverGeneralExporterType() {
        ...
        environment.setProperty("arconia.otel.logs.exporter.type", "otlp");
        when(context.getEnvironment()).thenReturn(environment);
        ...
        assertThat(outcome.isMatch()).isTrue();
        assertThat(outcome.getMessage())
                .contains("arconia.otel.logs.exporter.type is set to OTLP");
    }
