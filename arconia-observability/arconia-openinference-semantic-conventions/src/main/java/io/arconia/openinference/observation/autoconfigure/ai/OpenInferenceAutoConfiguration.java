...
public final class OpenInferenceAutoConfiguration {
    ...
    OpenInferenceGenerativeAiOnlyObservationPredicate openInferenceSpringAiOnlyObservationPredicate() {
        return new OpenInferenceGenerativeAiOnlyObservationPredicate();
    }
