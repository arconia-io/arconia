 ...
 * <p>
 * Code adapted from <a href="https://github.com/spring-projects/spring-boot/blob/v4.0.1/module/spring-boot-micrometer-tracing-opentelemetry/src/test/java/org/springframework/boot/micrometer/tracing/opentelemetry/autoconfigure/CompositeTextMapPropagatorTests.java">CompositeTextMapPropagatorTests.java</a>
...
class CompositeTextMapPropagatorTests {
    ...
    void createMapsInjectorsAndExtractors() {
        TracingProperties.Propagation properties = new TracingProperties.Propagation();
        properties.setProduce(List.of(TracingProperties.Propagation.PropagationType.W3C));
        properties.setConsume(List.of(TracingProperties.Propagation.PropagationType.B3));
        CompositeTextMapPropagator propagator = (CompositeTextMapPropagator) CompositeTextMapPropagator.create(properties, null);
