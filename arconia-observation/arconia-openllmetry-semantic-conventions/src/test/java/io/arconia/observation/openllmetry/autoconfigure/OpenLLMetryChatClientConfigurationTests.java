...
/**
 * Unit tests for {@link OpenLLMetryChatClientConfiguration}.
 */
class OpenLLMetryChatClientConfigurationTests {

    private final ApplicationContextRunner contextRunner = new ApplicationContextRunner()
            .withConfiguration(AutoConfigurations.of(OpenLLMetryChatClientConfiguration.class))
            .withBean(OpenLLMetryProperties.class, OpenLLMetryProperties::new);
