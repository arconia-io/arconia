...
class OpenInferenceAutoConfigurationTests {
    ...
    void autoActivatesWhenOnClasspath() {
        contextRunner.run(context -> {
            ...
            assertThat(context.getBean(AiObservationConventionsProvider.class).name()).isEqualTo("openinference");
    ...
    void doesNotActivateWhenDisabled() {
        contextRunner
                .withPropertyValues("arconia.observations.conventions.openinference.ai.enabled=false")
                .run(context -> {
