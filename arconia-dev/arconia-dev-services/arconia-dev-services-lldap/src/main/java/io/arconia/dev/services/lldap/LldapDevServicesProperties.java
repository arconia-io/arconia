...
/**
 * Properties for the LLDAP Dev Services.
 */
@ConfigurationProperties(prefix = LldapDevServicesProperties.CONFIG_PREFIX)
public class LldapDevServicesProperties implements BaseDevServicesProperties {

    public static final String CONFIG_PREFIX = "arconia.dev.services.lldap";
    ...
    /**
     * Fixed port for exposing the LDAP port to the host.
    ...
    /**
     * Fixed port for exposing the LLDAP Management Console to the host.
     * When it's 0 (default), a random available port is assigned dynamically.
     */
