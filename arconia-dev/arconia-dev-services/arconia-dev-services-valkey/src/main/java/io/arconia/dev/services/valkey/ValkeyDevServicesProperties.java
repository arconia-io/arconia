...
/**
 * Properties for the Valkey Dev Services.
 */
@ConfigurationProperties(prefix = ValkeyDevServicesProperties.CONFIG_PREFIX)
public class ValkeyDevServicesProperties implements BaseDevServicesProperties {

    public static final String CONFIG_PREFIX = "arconia.dev.services.valkey";
    ...
    /**
     * Fixed port for exposing the Valkey database port to the host.
