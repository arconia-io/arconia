...
/**
 * Properties for the Elasticsearch Dev Services.
 */
...
public class ElasticsearchDevServicesProperties implements BaseDevServicesProperties {
     ...
     */
    private String imageName = "docker.elastic.co/elasticsearch/elasticsearch:9.5.1";
    ...
    /**
     * Fixed port for exposing the Elasticsearch database port to the host.
