...
public class KafkaDevServicesProperties implements SharedDevServicesProperties {

    public static final String CONFIG_PREFIX = "arconia.dev.services.kafka";
     ...
     */
    private String imageName = "apache/kafka-native:4.3.1";
    ...
    /**
     * Fixed port for exposing the Kafka broker port to the host.
