...
public class RabbitMqDevServicesProperties implements BaseDevServicesProperties {
     ...
     */
    private String imageName = "rabbitmq:4.3-management-alpine";
    ...
    /**
     * Fixed port for exposing the RabbitMQ AMQP port to the host.
    ...
    /**
     * Fixed port for exposing the RabbitMQ Management Console port to the host.
     * When it's 0 (default), a random available port is assigned dynamically.
     */
