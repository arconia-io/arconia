...
public class JsonSchemaGenerator {
     ...
     */
    static {
        var schemaGeneratorConfigBuilder = new SchemaGeneratorConfigBuilder(SchemaVersion.DRAFT_2020_12, OptionPreset.PLAIN_JSON)
                .with(new JacksonModule(JacksonOption.RESPECT_JSONPROPERTY_REQUIRED))
                .with(new Swagger2Module())
                .with(Option.EXTRA_OPEN_API_FORMAT_VALUES)
                .with(Option.PLAIN_DEFINITION_KEYS);

        var typeSchemaGeneratorConfig = schemaGeneratorConfigBuilder
    ...
    public enum SchemaOption {
         ...
         * Beware, that OpenAI requires all properties to be required.
         */
        RESPECT_JSON_PROPERTY_REQUIRED,

        /**
         * Allow additional properties by default. Beware, that OpenAI requires additional properties NOT to be allowed.
         */
        ALLOW_ADDITIONAL_PROPERTIES_BY_DEFAULT,

        /**
         * Convert all "type" values to upper case. For example, it's require in OpenAPI 3.0 with Vertex AI.
         */
