...
| `arconia.dev.services.oracle.username`
| `test`
| Username to be used for connecting to the database.

| `arconia.dev.services.oracle.password`
| `test`
| Password to be used for connecting to the database.

| `arconia.dev.services.oracle.db-name`
| `test`
| Name of the database to be created.

| `arconia.dev.services.oracle.init-script-paths`
| `[]`
