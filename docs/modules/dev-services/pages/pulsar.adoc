...
[source,logs]
----
...i.a.d.s.startup  : Dev Service 'pulsar' is ready - Pulsar Management Console: http://localhost:<port>
----
...
| `0`
| Fixed port for exposing the Pulsar Management Console to the host. When it's 0 (default), a random available port is assigned dynamically.
|===
