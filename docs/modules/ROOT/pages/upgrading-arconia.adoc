...
Since Arconia is now based on Spring Boot 4.0, the automated recipe to upgrade Arconia also includes an upgrade to Spring Boot 4.0. For more information about the Spring Boot 4.0 upgrade, check out the https://github.com/arconia-io/arconia-migrations/blob/main/docs/spring-boot.md[relevant documentation].
...
./gradlew rewriteRun \
    ...
    -DactiveRecipe=io.arconia.rewrite.UpgradeArconia_0_21
----
...
./mvnw -U org.openrewrite.maven:rewrite-maven-plugin:run \
  ...
  -Drewrite.activeRecipes=io.arconia.rewrite.UpgradeArconia_0_21
----
