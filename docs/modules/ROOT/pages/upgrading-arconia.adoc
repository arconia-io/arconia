...
Arconia 0.29 baselines on Spring Boot 4.1. Your application must already be on Spring Boot 4.1 before you upgrade Arconia.
...
[source,shell]
----
arconia update framework --to-version 0.29
----
...
./gradlew rewriteRun \
    ...
    --no-parallel \
    -DactiveRecipe=io.arconia.rewrite.framework.UpgradeArconia_0_29
----
...
./mvnw -U org.openrewrite.maven:rewrite-maven-plugin:run \
  ...
  -Drewrite.activeRecipes=io.arconia.rewrite.framework.UpgradeArconia_0_29
----
