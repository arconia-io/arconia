...
----
ConvertDocumentRequest request = ConvertDocumentRequest.builder()
        .addHttpSources(URI.create("https://example.com/document.pdf"))
        .build();
...
try {
    ConvertDocumentRequest request = ConvertDocumentRequest.builder()
            .addHttpSources(URI.create("https://invalid-url.com/document.pdf"))
            .build();
    ...
    log.error("Client error during conversion: {}", e.getMessage());
} catch (HttpServerErrorException e) {
    log.error("Server error during conversion: {}", e.getMessage());
}
----
