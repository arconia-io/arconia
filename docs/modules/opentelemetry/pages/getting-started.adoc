...
TIP: If you are currently using OpenTelemetry Spring Boot Starter or relying on the Spring Boot Observability support, check out our xref:migration/migration-opentelemetry.adoc[Migration Guides] to learn how to migrate seamlessly to Arconia OpenTelemetry.
