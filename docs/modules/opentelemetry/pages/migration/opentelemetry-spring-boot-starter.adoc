...
The OpenTelemetry Spring Boot Starter doesn't support dev services. Check out our xref:getting-started.adoc#_dev-service[ getting started guide] to learn how to use the Arconia OpenTelemetry Dev Service LGTM and improve your developer experience while working with OpenTelemetry.
